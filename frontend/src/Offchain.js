...
(function (exports) {
  ...
  (PS["Ctl.Internal.Deserialization.WitnessSet"] =
    PS["Ctl.Internal.Deserialization.WitnessSet"] || {})
);
(function (exports) {
  /* global BROWSER_RUNTIME */
  ...
  (PS["Ctl.Internal.Deserialization.Language"] =
    PS["Ctl.Internal.Deserialization.Language"] || {})
);
(function ($PS) {
  // Generated by purs version 0.14.9
...
(function ($PS) {
  ...
  var Ctl_Internal_Deserialization_Language =
    $PS["Ctl.Internal.Deserialization.Language"];
  var Ctl_Internal_Types_Scripts = $PS["Ctl.Internal.Types.Scripts"];
  var Data_Tuple = $PS["Data.Tuple"];
  var convertPlutusScript = function (plutusScript) {
    var language = Ctl_Internal_Deserialization_Language.convertLanguage(
      $foreign.plutusScriptVersion(plutusScript)
    );
    return Data_Tuple.curry(Ctl_Internal_Types_Scripts.PlutusScript)(
      $foreign.plutusScriptBytes(plutusScript)
    )(language);
  };
...
(function (exports) {
  ...
  (PS["Ctl.Internal.Serialization.PlutusData"] =
    PS["Ctl.Internal.Serialization.PlutusData"] || {})
);
(function (exports) {
...
(function ($PS) {
  // Generated by purs version 0.14.9
  "use strict";
  $PS["Ctl.Internal.Types.PlutusData"] =
    $PS["Ctl.Internal.Types.PlutusData"] || {};
...
(function ($PS) {
  ...
  var convertBigInt = function (n) {
    return Data_Maybe.fromJust()(
      $foreign["_bigIntFromString"](Ctl_Internal_FfiHelpers.maybeFfiHelper)(
        Data_BigInt.toString(n)
      )
    );
  };
  ...
  var convertPlutusMap = function (mp) {
    var entries = Data_Functor.mapFlipped(Data_Functor.functorArray)(mp)(
      function (v) {
        return new Data_Tuple.Tuple(
          convertPlutusData(v.value0),
          convertPlutusData(v.value1)
        );
      }
    );
    return $foreign["_mkPlutusData_map"](
      $foreign["_packMap"](Data_Tuple.fst)(Data_Tuple.snd)(entries)
    );
  };
  var convertPlutusList = function (x) {
    return $foreign["_mkPlutusData_list"](
      $foreign["_packPlutusList"](Ctl_Internal_FfiHelpers.containerHelper)(
        Data_Functor.map(Data_Functor.functorArray)(convertPlutusData)(x)
      )
    );
  };
  var convertPlutusData = function (x) {
    ...
    throw new Error(
      "Failed pattern match at Ctl.Internal.Serialization.PlutusData (line 31, column 23 - line 36, column 37): " +
        [x.constructor.name]
    );
  };
  var convertConstr = function (alt) {
    return function (list) {
      return $foreign["_mkPlutusData_constr"](
        $foreign["_mkConstrPlutusData"](alt)(
          $foreign["_packPlutusList"](Ctl_Internal_FfiHelpers.containerHelper)(
            Data_Functor.map(Data_Functor.functorArray)(convertPlutusData)(list)
          )
        )
      );
    };
...
(function (exports) {
  ...
  (PS["Ctl.Internal.Serialization.PlutusScript"] =
    PS["Ctl.Internal.Serialization.PlutusScript"] || {})
);
(function ($PS) {
  // Generated by purs version 0.14.9
  ...
  var convertPlutusScript = function (v) {
    return (function () {
      ...
      throw new Error(
        "Failed pattern match at Ctl.Internal.Serialization.PlutusScript (line 24, column 11 - line 26, column 36): " +
  ...
  var choiceFn = {
    left: function (v) {
      return function (v1) {
        ...
        throw new Error(
          "Failed pattern match at Data.Profunctor.Choice (line 32, column 1 - line 35, column 16): " +
            [v.constructor.name, v1.constructor.name]
        );
      };
    },
...
(function ($PS) {
  ...
  var Ctl_Internal_Deserialization_WitnessSet =
    $PS["Ctl.Internal.Deserialization.WitnessSet"];
  var Ctl_Internal_Serialization_PlutusData =
    $PS["Ctl.Internal.Serialization.PlutusData"];
  var Ctl_Internal_Serialization_PlutusScript =
    $PS["Ctl.Internal.Serialization.PlutusScript"];
  var Ctl_Internal_Types_PlutusData = $PS["Ctl.Internal.Types.PlutusData"];
  var Data_Either = $PS["Data.Either"];
  ...
  var apply_params_to_script_either = $foreign.apply_params_to_script(
    Data_Either.Left.create
  )(Data_Either.Right.create);
  var applyArgs = function (script) {
    return function (paramsList) {
      return Data_Profunctor_Choice.left(Data_Profunctor_Choice.choiceFn)(
        ApplyArgsError
      )(
        (function () {
          var params = Ctl_Internal_Serialization_PlutusData.convertPlutusData(
            new Ctl_Internal_Types_PlutusData.List(paramsList)
          );
          return Control_Bind.bind(Data_Either.bindEither)(
            apply_params_to_script_either(params)(
              Ctl_Internal_Serialization_PlutusScript.convertPlutusScript(
                script
              )
            )
          )(function (appliedScript) {
            return new Data_Either.Right(
              Ctl_Internal_Deserialization_WitnessSet.convertPlutusScript(
                appliedScript
              )
            );
          });
...
(function (exports) {
  ...
  if (typeof BROWSER_RUNTIME != "undefined" && BROWSER_RUNTIME) {
    ...
    nft_no_hash_applied = read_script(
      "d1f18edece2ee922df6a5ca14dc01741dc62e00863ac9994846c75fd.plutus"
    );
  }
})(
