...
function TopLevelTabs() {
  return (
    <Tabs selectedTabClassName="selectedTab">
      <TabList className="TopLevelTabList">
        <Tab>Script</Tab>
        <Tab>NFT</Tab>
      </TabList>
      <TabPanel>
...
const ScriptForm = () => {
  ...
  return (
    <form>
      <InputBox lbl={"Ada Value:"} val={input.ada} onChange={onChangeAda} />
      <InputBox
        lbl={"Password:"}
        val={input.password}
        onChange={onChangePassword}
      />
      <Button text={"Lock Funds"} onClick={handleLock} />
      <Button text={"Unlock Funds"} onClick={handleUnlock} />
    </form>
  );
};
...
const NFTForm = () => {
  ...
  return (
    <form>
      ...
      <Button text={"Burn"} onClick={handleBurn} />
    </form>
  );
};
